...
function mostrarEnlaces($nombre) {
  ...
  <article class="enlaces">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" text="$nombre" id="btnEliminar" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
          ...
          0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/> </svg></a>
        </article>
  _END;
